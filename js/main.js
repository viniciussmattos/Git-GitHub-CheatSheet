(function () {
    ...
    window.openTopicDetails = (topicId) => {
        ...
        modalContent.innerHTML = `
            <div class="modal-content">
                <div>
                    ...
                    <div class="modal-content-bar"></div>
                    <p class="modal-content-text">${data.concept}</p>
                </div>
                <div class="modal-scenario-box">
                    <h4 class="modal-scenario-label">Scenario</h4>
                    <p class="modal-scenario-text">"${data.useCase}"</p>
                </div>
                <ul class="modal-steps">
                    ${data.steps.map((s, i) => `<li class="modal-step"><span class="modal-step-num">0${i + 1}</span><span class="modal-step-text">${s}</span></li>`).join('')}
                </ul>
            </div>
        `;
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        console.log('🚀 Git Premium Experience Loaded (Universal Mode)');
    });
})();
